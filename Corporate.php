...
<header>
    ...
    <nav class = "sticky">
		<div class="topnav" id="myTopnav">
		    ...
		    <a href="Corporate.php" title="Corporate Events"><span class = "imhere">CORPORATE EVENTS</span></a>
    ...
    <!-- carousel -->
		<div class="w3-content w3-section" style="max-width:100%">
		    <img class="mySlides w3-animate-fading" src="img/wedding_band_corporate_01.jpg" style="width:100%">
            <img class="mySlides w3-animate-fading" src="img/wedding_band_corporate_02.jpg" alt="Bachelor Boys Band - Wedding Band  - Who We Are" style="width:100%">
            <img class="mySlides w3-animate-fading" src="img/wedding_band_corporate_03.jpg" alt="Bachelor Boys Band - Wedding Band  - Who We Are" style="width:100%">
            <img class="mySlides w3-animate-fading" src="img/wedding_band_corporate_04.jpg" alt="Bachelor Boys Band - Wedding Band  - Who We Are" style="width:100%">
		</div>
...
<!-- end of header -->
    ...
    <div class="intro">
	    ...
	    <div class="introtextcontainer">
		    ...
		    <div class="introtext">
	            ...
	            <p>When your event needs to impress with more than just a DJ spinning the same old standard tracks, or a tired cover band trying to start a group dance... the Bachelor Boys Band is for you!</p>
		    </div>
		</div>
	...
	<div class = "corporateservices">
	
	    <h2>Corporate Services</h2>

        <p>
            The Bachelor Boys Band are trusted and relied upon by many of the world’s leading organizations. They choose us again and again not just because of the great music, incredible versatility and packed dance floors, but because of our rock-solid organization and logistics process leading up to the event.
            We provide industry leading entertainment services for small dinner events, to grand ballroom galas, to multi-day conventions, in the style and atmosphere to suit your event. Booking a truly amazing band has never been easier.
        </p>
    ...
    <div class="music">
	    ...
	    <p>We play a wide variety of musical genres at a truly world class standard. Each of our band members are full-time professional musicians, who excel at everything from Frank Sinatra, the Beatles and 
		Madonna, to Beyonce, Daft Punk and Justin Timberlake, and current dance hits. One night we might be performing a Great Gatsby themed Big Band show, then the next night an 80's Glam Rock Extravaganza. 
		Tell us your vision & we will work together to create the perfect experience for you and your guests!</p>
